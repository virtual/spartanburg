<div id="homeCarousel" class="pageCarousel {{$style}}">
  <div class="rotator">
    ...
    <div class="item"><img src="{{ $page->baseUrl }}/resources/images/photo-rotator/Rotator-mini-culinary.jpg?n=8875" width="800" height="200"
    ...
    <div class="item"><img
        src="{{ $page->baseUrl }}/resources/images/photo-rotator/Rotator-mini-Weekend-College.jpg?n=7330"
    ...
    <div class="item"><img src="{{ $page->baseUrl }}/resources/images/photo-rotator/Rotator-mini-cce.jpg?n=9673" width="800" height="200"
